...
namespace ImGui
{
    ...
    // dentro de alli colocar
    IMGUI_API bool          Icon_Button(const char* label, ImTextureID image, const ImVec2& size_arg);
    IMGUI_API bool          Tab(const char* label, ImTextureID image, bool selectable, const ImVec2& size_arg, const ImVec2& size_arg_icon);

    IMGUI_API bool          Keybind(const char* label, int* key, bool show_label);
    IMGUI_API bool          Keybind(const char* label, const char* description, int* key);
