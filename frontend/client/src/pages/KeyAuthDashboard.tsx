      ...
      <div className="relative flex w-full">
        <aside className="flex h-full w-64 flex-col border-r border-white/5 bg-zinc-950/80 backdrop-blur-xl">
          ...
          <nav className="mt-4 flex-1 overflow-y-auto px-3">
            <div className="mb-1 flex w-full items-center gap-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-transparent px-3 py-2.5 text-sm font-medium text-white shadow-[inset_0_0_0_1px_rgba(59,130,246,0.3)]">
              <Icon name="users" className="w-[18px] h-[18px]" />
              <span>Sellers</span>
              <span className="ml-auto h-1.5 w-1.5 rounded-full bg-blue-400 shadow-[0_0_8px] shadow-blue-400" />
            </div>
          </nav>
